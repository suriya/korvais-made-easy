/*
 * $Id: Korvai.java 701 2006-10-18 01:08:18Z suriya $
 */
...
public class Korvai {
  ...
  public void setNadais(int[] nadais) throws Exception {
    this.nadais = nadais;
    if (! this.checkInputNadais()) {
      throw new Exception("Input nadais are incorrect");
    }
    if (this.debug) {
  ...
  public void setThalam(int thalam) throws Exception {
    if (thalam%2 != 0) {
      throw new Exception("Thalam (in mathrai) should be a multiple of 2");
    }
    this.thalam = thalam;
    if (this.debug) {
